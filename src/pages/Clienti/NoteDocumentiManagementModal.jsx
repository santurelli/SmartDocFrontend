...
const NoteDocumentiManagementModal = ({ onClose }) => {
            ...
            <div className="modal-dialog modal-lg" role="document">
                <div className="modal-content">
                    <div className="modal-header">
                        ...
                        <h4 className="modal-title" style={{ fontWeight: 'bold' }}>Elenco note documenti</h4>
                    </div>
...
export default NoteDocumentiManagementModal;
