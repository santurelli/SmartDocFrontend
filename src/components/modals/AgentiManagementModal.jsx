                    ...
                    <div className="modal-body" style={{ maxHeight: 'calc(100vh - 210px)', overflowY: 'auto', padding: '25px' }}>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', gap: '15px' }}>
                            <button className="btn-premium-save" style={{ margin: 0, padding: '10px 20px', fontSize: '14px' }} onClick={handleAdd}>
                                <FaPlus style={{ marginRight: '8px' }} /> Nuovo Agente
                            </button>
                            ...
                            <table className="table" style={{ borderCollapse: 'separate', borderSpacing: '0 10px' }}>
                                <thead>
                                    <tr style={{ background: '#f8f9fa' }}>
                                        <th style={{ border: 'none', borderRadius: '10px 0 0 10px', padding: '12px 15px' }}>DENOMINAZIONE</th>
                                        <th style={{ border: 'none', padding: '12px 15px' }}>EMAIL</th>
                                        <th style={{ border: 'none', padding: '12px 15px' }}>% PROVV.</th>
                                    ...
                                    {list.length > 0 ? (
                                        list.map(item => (
                                            <tr key={item.id} style={{ boxShadow: '0 2px 5px rgba(0,0,0,0.05)', borderRadius: '10px' }}>
                                                <td style={{ border: 'none', padding: '15px', background: '#fff', borderRadius: '10px 0 0 10px', fontWeight: '500' }}>{item.denominazione}</td>
                                                <td style={{ border: 'none', padding: '15px', background: '#fff' }}>{item.email}</td>
                                                <td style={{ border: 'none', padding: '15px', background: '#fff' }}>{item.percProvvigione}%</td>
